...
\usepackage[table]{xcolor} % Required for table colors

\usepackage{rotating} % Allows landscape pages
...
\fancyhead[C]{Seminar Data Science \& Artificial Intelligence $\bullet$ SS25 Sim-to-Real in RL} % Custom header text
...
\normalsize \href{stud105956@fh-wedel.de}{stud105956@fh-wedel.de} % Your email address
}
...
\input{sections/transfer-techniques/observation}
\input{sections/transfer-techniques/action}
\input{sections/transfer-techniques/transition}
\input{sections/transfer-techniques/reward}
